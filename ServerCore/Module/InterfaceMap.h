...
#define SC_INTERFACE_ENTRY(IfaceType) \
    {&sc::InterfaceIdOf<IfaceType>::Get(), &sc::InterfaceGetter<SC_IfcClass, IfaceType>},
...
#define SC_INTERFACE_ENTRY_EX(IfaceType, IidExpr) {&IidExpr, &sc::InterfaceGetter<SC_IfcClass, IfaceType>},
...
#define SC_IMAP_ENTRIES_4(I0, I1, I2, I3) \
    SC_INTERFACE_ENTRY(I0) SC_INTERFACE_ENTRY(I1) SC_INTERFACE_ENTRY(I2) SC_INTERFACE_ENTRY(I3)

/// @brief 内部辅助：展开 5 个接口条目。
#define SC_IMAP_ENTRIES_5(I0, I1, I2, I3, I4) \
    SC_INTERFACE_ENTRY(I0) SC_INTERFACE_ENTRY(I1) SC_INTERFACE_ENTRY(I2) SC_INTERFACE_ENTRY(I3) SC_INTERFACE_ENTRY(I4)

/// @brief 内部辅助：展开 6 个接口条目。
#define SC_IMAP_ENTRIES_6(I0, I1, I2, I3, I4, I5) \
