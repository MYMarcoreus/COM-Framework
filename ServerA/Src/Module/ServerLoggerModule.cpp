...
ServerLoggerModule::ServerLoggerModule(sc::ComponentManager& componentManager)
    : sc::Module("logger"), componentManager_(componentManager)
{
}
...
bool ServerLoggerModule::Initialize()
{
    ...
    // ③ 启用文件输出
    common::Logger::Instance().OpenFile("servera.log");
    return true;
}
